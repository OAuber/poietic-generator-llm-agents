#!/usr/bin/env bash
# Demarre Poietic Generator + serveur IA V6 quantique + serveur de metriques V6.
# V6 route ses appels LLM via OpenRouter (OPENROUTER_API_KEY).
...
echo "=== Lancement serveur de metriques V6 (port 5006) ==="
"$PYTHON" "$ROOT/python/metrics_server_v6.py" &
METRICS_PID=$!

echo "=== Lancement serveur IA V6 quantique O-N (port 8006) ==="

...
Ce bot capture l'état du canvas et attend les instructions de Claude dans ce chat.
"""
...
logger = logging.getLogger("DirectCursorBot")

class DirectCursorBot:
    def __init__(self, api_url="http://localhost:8000", interval=15):
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(f"🤖 Bot direct connecté: {self.session_id}")
...
"""
    ...
    def run(self):
        ...
        print("🎨 Bot Direct Cursor démarré!")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Bot Direct Cursor pour Poietic Generator.")
    ...
    bot = DirectCursorBot(api_url=args.api_url, interval=args.interval)
    bot.run()
